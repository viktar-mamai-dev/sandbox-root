...
public class PathFileMain {
    private static final String FILE_1_ABSOLUTE = "D:\\workspace\\OracleCertifiedJava\\src\\main\\resources\\file111.txt";
    ...
    public static void main(String[] args) {
        ...
        Path path2 = Paths.get("D:\\workspace", "OracleCertifiedJava\\src", "main\\resources", "file222.txt");
        ...
        Path path7;
        out.println("Relativize : " + path1 + " and " + path2 + " ::: " + (path7 = path1.relativize(path2))); // both should be on the same disk, otherwise - exception
        out.println("Relativize : " + path12 + " and " + path6 + " ::: " + (path7 = path12.relativize(path6))); // outputs path2 if path2 is absolute, otherwise - appends
        out.println("Resolve : " + path12 + " and " + path7 + " ::: " + (path7 = path12.resolve(path7))); // outputs path2 if path2 is absolute, otherwise - appends
        ...
        try {
            ...
            Files.copy(path8, path9); // FileAlreadyExistsException if path9 exists, otherwise create and copy content
