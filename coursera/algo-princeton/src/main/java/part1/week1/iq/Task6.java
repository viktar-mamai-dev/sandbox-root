 ...
 * eggs. An egg breaks if it is dropped from floor TT or higher and does not break otherwise.
 * Return minimum number of eggs needed to define the floor in general case
 */
public class Task6 {
