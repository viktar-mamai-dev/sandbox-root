...
public class GFG {
    ...
    // The main function that calculates minimum cost of a Binary Search Tree. It mainly uses optCost() to
    // find the optimal cost.
    static int optimalSearchTree(int[] keys, int[] freq, int n) {
        // Here array keys[] is assumed to be sorted in increasing order. If keys[] is not sorted, then
