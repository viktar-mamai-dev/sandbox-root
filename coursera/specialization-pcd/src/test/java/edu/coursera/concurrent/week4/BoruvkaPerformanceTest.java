...
public class BoruvkaPerformanceTest extends TestCase {
  ...
  private static <C extends Component<C>, E extends Edge<C>> ExperimentResults driver(
      final String fileName, final BoruvkaFactory<C, E> factory) throws InterruptedException {
    ...
    for (int r = 0; r < 5; r++) {
      ...
      System.err.println(
          "  " + fileName + " - " + boruvkaImpl.getClass().getName() + " - " + elapsed);
  ...
  private void assertReasonablePercentError(final double expected, final double found) {
    ...
    assertTrue(
        String.format(
            ...
            reasonablePercError * 100.0, percError * 100.0),
  ...
  static class ExperimentResults {
    ...
    public ExperimentResults(
        final double elapsedTime, final long totalEdges, final double totalWeight) {
