...
/**
 * A helper class for generating different types of integer sequences. These are not necessarily
 * random sequences.
 */
public interface SequenceGenerator {
  ...
  /** Reset this sequence generator to generate the sequence from the beginning. */
  public void reset();
