...
public class BankTransactionsTest extends TestCase {
    ...
    private static long testDriver(final ThreadSafeBankTransaction impl) {
        ...
        assertEquals("Expected total balance before and after simulation to be equal, but was " + preSumOfBalances
                + " before and " + postSumOfBalances + " after", preSumOfBalances, postSumOfBalances);
    ...
    public void testObjectIsolation() {
        ...
        final long globalTime = testDriver(new BankTransactionsUsingGlobalIsolation());
        ...
        final String msg = String.format("Expected an improvement of at least %fx with object-based isolation, but saw %fx",
