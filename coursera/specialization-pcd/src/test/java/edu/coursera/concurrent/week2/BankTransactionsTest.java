...
public class BankTransactionsTest extends TestCase {
  private static final int numAccounts = 3_000;
  private static final int numTransactions = 800_000;
  ...
  private static long testDriver(final ThreadSafeBankTransaction impl) {
    ...
    assertEquals(
        "Expected total balance before and after simulation to be equal, but was "
            + preSumOfBalances
            + " before and "
            + postSumOfBalances
            + " after",
