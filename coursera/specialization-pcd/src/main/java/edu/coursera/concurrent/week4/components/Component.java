...
/**
 * An abstract definition of a component in a graph, which may be a singleton node or may be the
...
public abstract class Component<C extends Component> {
   ...
   *
   * @return The weight of this component, based on the number of edges that have been collapsed to
   *     form it.
   */
  public abstract double totalWeight();

  /**
   * Compute the number of edges that have been collapsed to form this component.
   *
