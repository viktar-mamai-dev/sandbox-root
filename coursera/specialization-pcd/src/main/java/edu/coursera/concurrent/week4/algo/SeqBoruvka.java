...
/** Sequential implementation of Boruvka's minimum spanning tree algorithm. */
public final class SeqBoruvka extends AbstractBoruvka<SeqComponent> {
  ...
  public void computeBoruvka(
      final Queue<SeqComponent> nodesLoaded, final SolutionToBoruvka<SeqComponent> solution) {
