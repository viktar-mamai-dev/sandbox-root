...
/** Represents a single account in a bank whose only contents is the balance of that account. */
public final class Account {
  ...
  /**
   * A dummy busy work function for simulating more work to increase isolated contention. While this
   * work is artificial in this setting, it serves to more accurately simulate real-world conditions
   * where a bank transfer is not a shared-memory operation (i.e., it must contend with network
   ...
   * @return true if it was possible to add that amount (i.e. amount > 0), false otherwise.
   */
  ...
  /**
   * Transfer the specified amount from this account to the specified target account.
   *
