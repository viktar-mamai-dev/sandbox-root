...
public final class Website implements Serializable {
  ...
  private int id;
  /**
   * List of edges from this website (i.e. links to other websites), represented by a list of the
   * IDs for the destination sites.
   */
  ...
  /**
   * Get an iterator over edges outbound from this site, defined by the integer IDs of the
   * destination sites.
   *
