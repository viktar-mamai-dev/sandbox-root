...
public final class Matrix {
    ...
    /**
     * Get the offset in the flattened values array of the first element in the specified row.
     *
    ...
    /**
     * Get the raw, one-dimensional values array used to store this matrices values.
     *
