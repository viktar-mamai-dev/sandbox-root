...
/**
 * A class to represent a virtual, in-memory filesystem. PCDPFilesystem exposes two user-visible
 * APIs: one for adding a file to a given virtual filesystem (addFile) and one for reading the
 * contents of a file that already exists (readFile).
 */
public class PCDPFilesystem {
   ...
   * @return The contents of the specified file, or null if the file does not seem to exist.
   */
