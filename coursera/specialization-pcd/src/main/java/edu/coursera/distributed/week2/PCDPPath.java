...
/** Class for storing the absolute path to a file as separate path components. */
public final class PCDPPath {
  /** PCDPPath components. */
  private final String[] components;

  /**
   * Construct a path object from an absolute path that uses the '/' separator.
   *
   * @param path String representation of the path to parse into a PCDPPath object.
   */
