...
/** Wrapper class for an MPI_Request representing a handle to an asynchronous MPI communication. */
public abstract class MPI_Request {
  /** Wrapped request object. */
  protected final Memory request;
  /**
   * Pointer to the buffer that the asynchronous operation is copying to or from. This must be a
   * native buffer to prevent JVM GC from moving it around during the asynchronous communication.
   */
