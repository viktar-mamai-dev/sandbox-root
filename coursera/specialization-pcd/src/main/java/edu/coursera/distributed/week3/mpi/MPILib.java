...
interface MPILib extends Library {
    ...
    int MPI_Recv(IntBuffer buf, int count, Pointer datatype, int src, int tag, Pointer comm, Pointer status);

    int MPI_Recv(DoubleBuffer buf, int count, Pointer datatype, int src, int tag, Pointer comm, Pointer status);

    int MPI_Isend(Memory buf, int count, Pointer datatype, int dest, int tag, Pointer comm, Memory request);

    int MPI_Irecv(Memory buf, int count, Pointer datatype, int src, int tag, Pointer comm, Memory request);
