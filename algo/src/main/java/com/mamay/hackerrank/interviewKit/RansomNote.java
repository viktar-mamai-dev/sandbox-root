package com.mamay.hackerrank.interviewKit;
...
public class RansomNote {
  ...
  private static void checkMagazine(String[] magazine, String[] note) {
    ...
    try (PrintWriter bufferedWriter =
        new PrintWriter(new FileWriter(new File("output_hackerrank.txt")))) {
  ...
  private static String checkMaps(
      HashMap<String, Integer> magazinMap, HashMap<String, Integer> noteMap) {
