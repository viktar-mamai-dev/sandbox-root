...
class DeleteDuplicatesFolderTest {
    ...
    private final static ListComparator comparator = new ListComparator();

    private static final DeleteDuplicateFolders solution = new DeleteDuplicateFolders();

    @Test
    public void test1() {
        List<List<String>> path = Arrays.asList(Arrays.asList("a"), Arrays.asList("c"),
                Arrays.asList("d"), Arrays.asList("a", "b"),
                Arrays.asList("c", "b"), Arrays.asList("d", "a"));
    ...
    @Test
    public void test2() {
        List<List<String>> path = Arrays.asList(Arrays.asList("a"), Arrays.asList("c"), Arrays.asList("a", "b"),
                Arrays.asList("c", "b"), Arrays.asList("a", "b", "x"), Arrays.asList("a", "b", "x", "y"),
                Arrays.asList("w"), Arrays.asList("w", "y"));
        List<List<String>> expected = Arrays.asList(Arrays.asList("c"), Arrays.asList("c", "b"),
    ...
    @Test
    public void test3() {
        List<List<String>> path = Arrays.asList(Arrays.asList("a", "b"), Arrays.asList("c", "d"),
                Arrays.asList("c"), Arrays.asList("a"));
        List<List<String>> expected = Arrays.asList(Arrays.asList("c"), Arrays.asList("c", "d"),
                Arrays.asList("a"), Arrays.asList("a", "b"));
        List<List<String>> actual = solution.deleteDuplicateFolder(path);
