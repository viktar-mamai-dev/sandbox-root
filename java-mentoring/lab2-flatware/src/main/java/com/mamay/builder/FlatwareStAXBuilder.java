...
public class FlatwareStAXBuilder extends AbstractFlatwareBuilder {
    ...
    private PrimaryFlatware buildPrimaryFlatware(XMLStreamReader reader)
    ...
    private SecondaryFlatware buildSecondaryFlatware(XMLStreamReader reader)
        ...
        Date production = format.parse(reader.getAttributeValue(null,
                "production-date"));
    ...
    private Flatware.Visual getXMLVisual(XMLStreamReader reader)
            throws XMLStreamException {
