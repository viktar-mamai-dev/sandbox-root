 ...
 * Copyright (c) 2023
 */
package com.mamay.patterns.blinov.structural;
...
class FacadeValidator {
  public boolean validateSAXwithXSD(
      String xmlFileName, String schemaFileName, DefaultHandler handler) {
...
class ValidatorSAXwithXSD {
  public static void main(String[] args) {
    ...
    if (v.validateSAXwithXSD("data/students.xml", "data/students.xsd", new StudentHandler()))
