...
public class StreamsTester1 {
  ...
  public static void method2() {
    ...
    classified =
        books.stream()
            .collect(Collectors.groupingBy(Book::getTitle, Collectors.groupingBy(Book::getPrice)));
  ...
  public static void method1() {
    ...
    books.stream().forEach(b -> System.out.println(b.getTitle() + ":" + b.getPrice())); // modified
  }
