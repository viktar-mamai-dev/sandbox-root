...
public class Lambda4 {
  ...
  void testScopes() {
    ...
    convert = stringConverter2.convert(2);
    System.out.println(convert); // 15

    String[] array = new String[1];
    Lambda2.Converter<Integer, String> stringConverter3 =
        (from) -> {
          array[0] = "Hi there";
          return array[0] + String.valueOf(from);
        };

    System.out.println(stringConverter3.convert(23));
