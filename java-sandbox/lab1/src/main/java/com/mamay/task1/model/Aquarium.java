...
public class Aquarium {
  ...
  @Getter @Setter private Item type;
  private Set<Component> components;
  @Getter private int countOfOrders;
  ...
  public int getTotalCost() {
    return components.stream().mapToInt(Component::getCost).sum() + type.getCost();
  }
