...
public class LoginController {
  ...
  public ModelAndView login(
    ...
    if (error != null) {
      model.addObject(
          "badCredentials", messageSource.getMessage("message.error.badCredentials", null, locale));
    }

    Authentication auth = SecurityContextHolder.getContext().getAuthentication();
    if (logout != null && auth != null && auth.getName() != null) {
      model.addObject("logoutMessage", messageSource.getMessage("message.logout", null, locale));
    }
