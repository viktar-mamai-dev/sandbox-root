...
public class ResultSetCreator {
    public static NewsEntity createNews(ResultSet rs) throws NewsException {
        try {
            ...
            Integer fullText = rs.getInt(SchemaSQL.NEWS_VIEW_COUNT);
            ...
            LocalDateTime modificationDate = rs.getObject(SchemaSQL.NEWS_MODIFICATION_DATE, LocalDateTime.class);
            NewsEntity entity = new NewsEntity();
            entity.setShortText(shortText);
            entity.setViewCount(fullText);
    ...
    public static CommentEntity createComment(ResultSet rs) throws NewsException {
        try {
            ...
            LocalDateTime creationDate = rs.getObject(SchemaSQL.COMMENT_CREATION_DATE, LocalDateTime.class);
